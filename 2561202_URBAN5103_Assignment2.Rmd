...
```{r hhsurvey person}
hhsurvey_person <- read.csv("E:/Salmon/UofG/Semester2/TPM/Assignment2/data/2017-2019-pr2-datafiles/2017-2019-pr2-2-Person.csv", header = TRUE)
...
# Household filter
hhsurvey_household <- read.csv("E:/Salmon/UofG/Semester2/TPM/Assignment2/data/2017-2019-pr2-datafiles/2017-2019-pr2-1-Household.csv", header = TRUE)
...
# Vehicle filter
hhsurvey_vehicle <- read.csv('E:/Salmon/UofG/Semester2/TPM/Assignment2/data/2017-2019-pr2-datafiles/2017-2019-pr2-3-Vehicle.csv', header = TRUE)
...
# Trip filter
hhsurvey_trip <- read.csv('E:/Salmon/UofG/Semester2/TPM/Assignment2/data/2017-2019-pr2-datafiles/2017-2019-pr2-5-Trip.csv', header = TRUE)
